...
class FeaturesTest < ApplicationSystemTestCase
  ...
  test "creating a Feature" do
    ...
    fill_in "Content", with: @feature.content
    fill_in "Contentsortno", with: @feature.contentSortNo
    fill_in "Deleteflg", with: @feature.deleteFlg
    fill_in "No", with: @feature.no
    fill_in "Type", with: @feature.type
    fill_in "Up date", with: @feature.up_date
